...
import networking.HttpsTrustManager;
import signup.SignUpFormActivity;

public class ShufptiVerificationServicesActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private final String clientId = "cc30e2766c4594ad53396175b6ca3cda24fff531ce98bf48aaff0f936dbdc480"; //Set your client Id here
    private final String secretKey = "xuSH1Ip2YG8BS4ekks2Mo1CWkwY1UjAe"; //Set your secret key here.
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.fragment_shufpti_verification_services);
    ...
    public void onClick(View v) {
        ...
        if (v == continueButton) {
            ...
            if (!isFaceChecked && !isDocChecked && !isAddressChecked && !isDoc2Checked && !isConsentChecked && !isPhoneChecked && !isBgChecked) {
                Helper.displayAlertMessage(this, getString(R.string.select_service));
            } else {
    ...
    private void sendVerificationRequest() {
        ...
        if (requestObj != null) {
            HttpsTrustManager.allowAllSSL();
            shuftipro.shuftiproVerification(requestObj, AuthKeys, Config, this, responseSet -> {
                PreferenceConnector.saveShuftiResponse(getApplicationContext(),responseSet.get("body"), String.valueOf(responseSet.values()));
                Log.e("Response", responseSet.toString());
             //   Toast.makeText(getApplicationContext(), responseSet.toString(), Toast.LENGTH_SHORT).show();
                Constants.SHUFTI_RESULT=responseSet.get("body");
                uncheckAllOptions();
