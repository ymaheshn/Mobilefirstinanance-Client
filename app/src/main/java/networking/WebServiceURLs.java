...
public class WebServiceURLs {
    ...
    public static String ALL_DYNAMIC_FORMS_URL = "/mff/api/profiles/forms/mobileApp?access_token=";
    ...
    public static String GET_EVENTS_BY_CONTRACTUUID_URL = "/mff/api/geteventsBycontractUUID?access_token=";
    ...
    public static String CASH_FLOW_UPDATE_URL = "/mff/api/workflowTemplateDetails/WORKFLOW_PROFILE_ID?access_token=";
