...
public class BluetoothPair {
     ...
     */
    public static String TAG = "Bluetooth Pair";
...
//            Boolean returnValue = (Boolean) removeBondMethod.invoke(btDevice, ar);
            ...
            Log.d(TAG, "Return Value>>setPin:" + returnValue.toString());
        } catch (SecurityException e) {
            // throw new RuntimeException(e.getMessage());
            Log.e(TAG, ">>setPin:" + e.getMessage());
            e.printStackTrace();
        } catch (IllegalArgumentException e) {
            // throw new RuntimeException(e.getMessage());
            Log.e(TAG, "returnValue >>setPin:" + e.getMessage());
            e.printStackTrace();
        } catch (Exception e) {
            Log.e(TAG, "returnValue >>setPin:" + e.getMessage());
            e.printStackTrace();
    ...
    static public boolean cancelPairingUserInput(BluetoothDevice btDevice)
            throws Exception {
        Log.e(TAG, "BlueTooth Control <<<<<<<<<<<<<<cancelPairingUserInput>>>>>>>>>>>>>>");
        Class<? extends BluetoothDevice> btClass = btDevice.getClass();
    ...
    static public boolean cancelBondProcess(BluetoothDevice btDevice)
            throws Exception {
        Log.e(TAG, "BlueTooth Control <<<<<<<<<<<<<<cancelBondProcess>>>>>>>>>>>>>>");
        Boolean returnValue = false;
        try {
            Class<? extends BluetoothDevice> btClass = btDevice.getClass();
            ...
            // throw new RuntimeException(e.getMessage());
            Log.e(TAG, "returnValue >>cancelBondProcess:" + e.getMessage());
            e.printStackTrace();
        } catch (IllegalArgumentException e) {
            // throw new RuntimeException(e.getMessage());
            Log.e(TAG, "returnValue >>cancelBondProcess:" + e.getMessage());
